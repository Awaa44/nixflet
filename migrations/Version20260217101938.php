...
final class Version20260217101938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie RENAME INDEX uniq_aa3a93345e237 TO UNIQ_AA3A93345E237E06A4265897');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie RENAME INDEX uniq_aa3a93345e237e06a4265897 TO UNIQ_AA3A93345E237');
    }
}
