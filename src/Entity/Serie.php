...
class Serie
{
    ...
    #[Assert\Length(min: 3, max: 200, minMessage: 'Le titre doit avoir au moins {{ limit }} caractères',
    ...
    #[ORM\Column(length: 255)]
    #[Assert\NotBlank(message: 'Vous devez choisir un statut')]
    #[Assert\Choice(choices: ['returning', 'ended', 'Canceled'], message: 'Choix non valide')]
    private ?string $status = null;

    #[ORM\Column(nullable: true)]
    #[Assert\Range(min: 0, max: 10, notInRangeMessage: 'Cette valeur doit être comprise entre 0 et 10')]
    ...
    #[Assert\When(
        ...
        //je vérifie que la date de fin est vide
        constraints: [
            new Assert\Blank(message: "Le statut choisi ne peut pas avoir de date de fin")
        ]
    )]
    #[Assert\When(
        //si status !== returning
        ...
        //je vérifie que la date de fin est vide
        constraints: [
            new Assert\Blank(message: "Le statut choisi implique une date de fin")
        ]
    )]
